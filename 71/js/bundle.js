...
function forms(formSelector,modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            const json = JSON.stringify(Object.fromEntries(formData.entries()));    //превращаем данные формы в массив массивов, далее в объект, затем в json-формат
...
function tab(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass){
    ...
    function showTabContent (i = 0) {                               //с ES6 если в ф-ю не дали аргумента, то можна присвоить 0 по дефолту
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_tab__WEBPACK_IMPORTED_MODULE_0__.default)('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.default)('[data-modal]', '.modal', modalTimerId);
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2021-03-08');
